            ...
            <SafeAreaView style={styles.container}>
                ...
                <View style={styles.wrapper}>
                    ...
                    <View style={styles.title}>
                        <Text style={styles.content_title}>Thêm dữ liệu</Text>
                    </View>
                    ...
                    <TouchableOpacity style={styles.btn} onPress={() => onHandleAddData()}>
                        <Text>Lưu dữ liệu</Text>
                    </TouchableOpacity>
                </View>
            </SafeAreaView>
        </KeyboardAvoidingView>
