import { deleteData, getAll, getDetail } from '@/apis'
...
function List() {
  ...
  // Ta chỉ muốn snapPointSheet hiển thị tối đa 40% chiều cao toàn bộ màn hình (Nó sẽ hiển thị phía dưới cùng màn hình)
  const snapPointSheet = ['40%']
  ...
  const showHeader = () => {
    return (
      <View style={styles.container}>
        {/* <Search keySearch={keySearch} onHandleChangeText={onHandleChangeText} onHandleSubmitEditing={onHandleSubmitEditing} /> */}
        <View style={[styles.content_header_footer, styles.content_header]}>
          <Text style={styles.text_header_footer}>Danh sách dữ liệu</Text>
          <TouchableOpacity style={styles.button_header_footer} onPress={handleButtonDown}>
